...
BUILD_TARGETS = \
	...
	speculative infill tokenize benchmark-matmult parallel finetune export-lora lookahead lookup l2 tests/test-c.o
...
l2: examples/l2/l2.cpp ggml.o llama.o $(COMMON_DEPS) $(OBJS)
	$(CXX) $(CXXFLAGS) $(filter-out %.h,$^) -o $@ $(LDFLAGS)
